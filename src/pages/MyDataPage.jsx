...
export default function MyDataPage() {
  ...
  // Load initial data from user_metadata
  useEffect(() => {
    if (user) {
        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ marginBottom: '2.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <h1 style={{ 
              ...
              <i className="fas fa-user-circle" style={{ marginRight: '0.75rem', color: 'var(--primary)' }}></i>
              Mis Datos
            </h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem' }}>
              Completá tu información de contacto para que los interesados puedan comunicarse con vos más fácilmente.
            </p>
          </div>
          ...
          {authLoading ? (
            ...
            <div style={{
              ...
              <h2 style={{ marginBottom: '1rem', fontWeight: 700 }}>Iniciá sesión para editar tus datos</h2>
              <p style={{ color: 'var(--text-muted)', marginBottom: '2rem', lineHeight: 1.6 }}>
                Necesitamos que te identifiques para poder asociar y resguardar tu información de perfil.
              </p>
            ...
            <div style={{
              ...
              {statusMessage.text && (
                <div style={{
                  ...
                  <i className={`fas ${statusMessage.type === 'success' ? 'fa-circle-check' : 'fa-circle-xmark'}`} style={{ fontSize: '1.2rem' }}></i>
                  <span>{statusMessage.text}</span>
                </div>
              )}

              <form onSubmit={handleSubmit} className="publish-form" style={{ padding: 0 }}>
